...
router.get("/ukvd/:registrationNumber", async (req, res) => {
  var config = {
    method: "get",
    url: process.env["ONE_AUTO_API_URL"] + `/ukvehicledata/vehicleandmodeldetailsfromvrm?vehicle_registration_mark=${req.params.registrationNumber.toString()}`,
    headers,
  };
...
router.get("/experian/:registrationNumber", async (req, res) => {
  var config = {
    method: "get",
    url: process.env["ONE_AUTO_API_URL"] + `/experian/autocheck/v2?vehicle_registration_mark=${req.params.registrationNumber.toString()}`,
    headers,
  };
...
router.get("/carguide/salvagecheck/:registrationNumber", async (req, res) => {
  var config = {
    method: "get",
    url: process.env["ONE_AUTO_API_URL"] + `/carguide/salvagecheck?vehicle_registration_mark=${req.params.registrationNumber.toString()}`,
    headers,
  };
...
router.get("/carguide/mot/:registrationNumber", async (req, res) => {
  var config = {
    method: "get",
    url: process.env["ONE_AUTO_API_URL"] + `/carguide/mothistoryandpredictions?vehicle_registration_mark=${req.params.registrationNumber.toString()}`,
    headers,
  };
...
router.get("/autotrader/valuation/:registrationNumber/:currentMileage/:vehicleCondition", async (req, res) => {
  var config = {
    method: "get",
    url:
